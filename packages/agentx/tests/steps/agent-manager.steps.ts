...
Then("it should throw error containing {string}", function (this: TestWorld, expectedMessage: string) {
...
Then("the agent lifecycle should be {string}", function (this: TestWorld, expectedLifecycle: string) {
...
Then("agentx.agents.has should return false for {string}", function (this: TestWorld, agentId: string) {
  const local = this.agentx as AgentXLocal;
...
When("I call agentx.agents.destroy with {string}", async function (this: TestWorld, agentId: string) {
  const local = this.agentx as AgentXLocal;
  try {
